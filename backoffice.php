...
<p>
    Here you can manage your business partner.
</p>
...
<div class="row">
    <div class="boxBack shadow border col-md mt-5 mb-5">
        <div class="row">
            ...
            <form class="form-inline my-2 my-lg-0 offset-1 col-md-2">
                <input onkeyup="searchPartners()" class="form-control mr-sm-2 mt-3" id="searchMembers" type="searchPartners" placeholder="Rechercher" aria-label="search">
            </form>
        </div>
        <div class="row">
            <div class="offset-md-1 col-md-10">
